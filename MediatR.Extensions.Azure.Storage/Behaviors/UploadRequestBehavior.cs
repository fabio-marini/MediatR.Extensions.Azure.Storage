...
namespace MediatR.Extensions.Azure.Storage
{
    ...
    {
        public UploadRequestBehavior(IOptions<UploadBlobOptions<TRequest>> opt, PipelineContext ctx = null, ILogger log = null) 
            : base(opt, ctx, log)
        {
        }
    }
    ...
    {
        public UploadRequestBehavior(IOptions<UploadBlobOptions<TRequest>> opt, PipelineContext ctx = null, ILogger log = null) 
            : base(new UploadBlobCommand<TRequest>(opt, ctx, log), ctx, log)
        {
        }
    }
}
