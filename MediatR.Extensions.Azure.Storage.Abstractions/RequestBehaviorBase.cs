...
namespace MediatR.Extensions.Azure.Storage.Abstractions
{
    ...
    {
        public RequestBehaviorBase(ICommand<TRequest> cmd, PipelineContext ctx = null, ILogger log = null) : base(cmd, ctx, log)
        {
        }
    }
    ...
    public abstract class RequestBehaviorBase<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IRequest<TResponse>
    {
        ...
        public RequestBehaviorBase(ICommand<TRequest> cmd, PipelineContext ctx = null, ILogger log = null)
        {
            this.cmd = cmd;
            this.ctx = ctx;
